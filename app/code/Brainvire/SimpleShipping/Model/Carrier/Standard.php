...
use Brainvire\SimpleShipping\Model\Carrier\Standard\ItemPriceCalculator;
...
class Standard extends AbstractCarrier implements CarrierInterface
{
    ...
    public function __construct(
        ...
        \Brainvire\SimpleShipping\Model\Carrier\Standard\ItemPriceCalculator $itemPriceCalculator,
        ...
        if ($request->getAllItems()) {
            foreach ($request->getAllItems() as $item) {
                ...
                if ($item->getHasChildren() && $item->isShipSeparately()) {
                    ...
                    && ($freeShippingMethod === null || $freeShippingMethod === 'standard')
                ) {
