...
use Brainvire\SimpleShipping\Model\Carrier\PriorityShipping\ItemPriceCalculator;
...
/**
 * Priority Shipping shipping model
 *
 * @api
 * @since 100.0.2
 */
class PriorityShipping extends AbstractCarrier implements CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'priority_shipping';
    ...
    public function __construct(
        ...
        \Brainvire\SimpleShipping\Model\Carrier\PriorityShipping\ItemPriceCalculator $itemPriceCalculator,
        ...
        if ($request->getAllItems()) {
            foreach ($request->getAllItems() as $item) {
                ...
                if ($item->getHasChildren() && $item->isShipSeparately()) {
                    ...
                    && ($freeShippingMethod === null || $freeShippingMethod === 'priority_shipping')
                ) {
    ...
    private function createResultMethod($shippingPrice)
    {
        ...
        $method->setCarrier('priority_shipping');
        $method->setCarrierTitle($this->getConfigData('title'));

        $method->setMethod('priority_shipping');
