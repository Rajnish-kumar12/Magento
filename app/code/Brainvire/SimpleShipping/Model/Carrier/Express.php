...
use Brainvire\SimpleShipping\Model\Carrier\Express\ItemPriceCalculator;
...
class Express extends AbstractCarrier implements CarrierInterface
{
    ...
    public function __construct(
        ...
        \Brainvire\SimpleShipping\Model\Carrier\Express\ItemPriceCalculator $itemPriceCalculator,
        ...
        if ($request->getAllItems()) {
            foreach ($request->getAllItems() as $item) {
                ...
                if ($item->getHasChildren() && $item->isShipSeparately()) {
                    ...
                    && ($freeShippingMethod === null || $freeShippingMethod === 'express_express')
                ) {
