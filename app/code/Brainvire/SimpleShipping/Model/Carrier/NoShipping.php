...
use Brainvire\SimpleShipping\Model\Carrier\NoShipping\ItemPriceCalculator;
 ...
 * @since 100.0.2
 */
class NoShipping extends AbstractCarrier implements CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'no_shipping';
    ...
    public function __construct(
        ...
        \Brainvire\SimpleShipping\Model\Carrier\NoShipping\ItemPriceCalculator $itemPriceCalculator,
        ...
        if ($request->getAllItems()) {
            foreach ($request->getAllItems() as $item) {
                ...
                if ($item->getHasChildren() && $item->isShipSeparately()) {
                    ...
                    && ($freeShippingMethod === null || $freeShippingMethod === 'no_shipping')
                ) {
    ...
    private function createResultMethod($shippingPrice)
    {
        ...
        $method->setCarrier('no_shipping');
        $method->setCarrierTitle($this->getConfigData('title'));

        $method->setMethod('no_shipping');
