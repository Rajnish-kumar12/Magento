...
use Brainvire\SimpleShipping\Model\Carrier\CanadaExpress\ItemPriceCalculator;
...
/**
 * Canada Express shipping model
 *
 * @api
 * @since 100.0.2
 */
class CanadaExpress extends AbstractCarrier implements CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'canada_express';
    ...
    public function __construct(
        ...
        \Brainvire\SimpleShipping\Model\Carrier\CanadaExpress\ItemPriceCalculator $itemPriceCalculator,
        ...
        if ($request->getAllItems()) {
            foreach ($request->getAllItems() as $item) {
                ...
                if ($item->getHasChildren() && $item->isShipSeparately()) {
                    ...
                    && ($freeShippingMethod === null || $freeShippingMethod === 'canada_express')
                ) {
    ...
    private function createResultMethod($shippingPrice)
    {
        ...
        $method->setCarrier('canada_express');
        $method->setCarrierTitle($this->getConfigData('title'));

        $method->setMethod('canada_express');
