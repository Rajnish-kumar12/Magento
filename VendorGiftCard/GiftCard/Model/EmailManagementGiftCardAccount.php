 ...
 */
class EmailManagementGiftCardAccount extends EmailManagement
{
    /**
     * Core store config
     *
    ...
    public function sendEmail(GiftCardAccountInterface $giftcardAccount)
    {
        ...
        $transport = $this->transportBuilder->setTemplateIdentifier(
            ...
            [
                ...
                'barcode' => '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode($code, $generator::TYPE_CODE_128)) . '">',
            ]
        )->setFrom(
