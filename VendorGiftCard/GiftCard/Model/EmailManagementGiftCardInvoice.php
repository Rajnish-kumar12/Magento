 ...
 */
class EmailManagementGiftCardInvoice extends GiftCardItemEmail
{
    /**
     * Gift card data
     *
    ...
    public function send(
        ...
        $balance = $this->localeCurrency->getCurrency($baseCurrencyCode)
            ...
            foreach ($codes as $code) {
                 ...
                 $barcodeImage = '<img src="data:image/png;base64,' . base64_encode($barcodeGenerator->getBarcode($code, $barcodeGenerator::TYPE_CODE_128)) . '">';
                 $barcodeHtml .= $barcodeImage . "<br>";
            }
            $store = $this->_storeManager->getStore();
            $product = $giftCardOrderItem->getProduct();
            ...
            'barcode' => $barcodeHtml,
            'product_image' => '<img src="' . $productImageUrl . '" alt="' . $product->getName() . '">'
        ];
